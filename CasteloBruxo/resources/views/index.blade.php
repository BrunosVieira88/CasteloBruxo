<x-layout title="CasteloBruxo">
    <style>
        .fade-out {
            background: radial-gradient(circle, rgba(255, 255, 255, 0) 0%, rgba(15, 15, 15, 0.8) 30%, rgba(255, 255, 255, 0.8) 50%, rgba(255, 255, 255, 0) 80%);
            animation: aging 20s linear forwards infinite;
...
display: none;
    ...
    <section >
      ...
      <section class="container">
                ...
                <div class="carousel-inne carousel-container">
                  <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgba(240, 248, 255, 0.2);">
                      ...
                      <a href="Personagens/PersonagensIndex.html"  ><button class="btn btn-primary ">SAIBA MAIS</button></a>
                    </div>
                  </div>
                  <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgba(240, 248, 255, 0.2);">
                        ...
                        <a href="ConselhoMagicoBrasileiro/CmbIndex.html"  ><button class="btn btn-primary">SAIBA MAIS</button></a>
                    </div>
                  </div>
                  <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgba(240, 248, 255, 0.2);">
                        ...
                        <a href="CB/casteloIndex.html"  ><button class="btn btn-primary">SAIBA MAIS</button></a>
                    </div>
                  </div>
                  <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgba(240, 248, 255, 0.2);">
                        ...
                        <a href="Questionario.html"  ><button class="btn btn-primary">SAIBA MAIS</button></a>
                    </div>
                  </div>
                </div>
        ...
        <audio id="myAudio">
          <source src="hp.m4a" type="audio/mpeg">
        </audio>
    </section>
    </section>
    <script>
